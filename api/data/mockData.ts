...
export const orders: Order[] = [
  ...
  },
  {
    ...
    riderId: 'r3',
    riderName: '张师傅',
    items: [{ id: 'i4', name: '炸酱面', quantity: 2, price: 22 }],
    totalAmount: 44,
  },
  {
    id: 'o3',
...
export const lockerCellsData: Record<string, LockerCell[]> = {
...
export const incidents: FoodSafetyIncident[] = [
  {
    id: 'inc1',
    merchantId: 'm5',
    merchantName: '意式披萨屋',
...
export const generateSalesData = (merchantId: string): { hour: number; orders: number }[] => {
  const data: { hour: number; orders: number }[] = []
...
export const getFoodSafetyRating = (level: 'A' | 'B' | 'C') => {
